...
export function createSystemStyles(palette: Palette) {
  return StyleSheet.create({
    ...
    zoomPreset: { width: 44, minHeight: 44, alignItems: 'center', justifyContent: 'center' },
    ...
    candidateMarker: { position: 'absolute', zIndex: 3, width: 44, height: 44, alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: palette.candidateMarkerBorder, borderRadius: 22, backgroundColor: palette.candidateMarkerBg },
    ...
    resultCard: { gap: 10, padding: 18, borderWidth: 1, borderColor: palette.resultBorder, borderRadius: 16, borderCurve: 'continuous', backgroundColor: palette.resultOverlay, boxShadow: palette.resultShadow },
    ...
    scanAgain: { minHeight: 44, paddingHorizontal: 8, alignItems: 'center', justifyContent: 'center' },
    ...
    candidateNavButton: { minHeight: 44, minWidth: 54, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: palette.navButtonBorder, borderRadius: 10, borderCurve: 'continuous' },
    ...
    openAction: { flex: 1, minHeight: 44, alignItems: 'center', justifyContent: 'center', borderRadius: 12, borderCurve: 'continuous', backgroundColor: palette.openAction },
    openActionText: { color: '#FFFFFF', fontSize: 14, fontWeight: '900' },
    copyAction: { flex: 1, minHeight: 44, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: palette.copyActionBorder, borderRadius: 12, borderCurve: 'continuous' },
    copyActionText: { color: palette.copyActionText, fontSize: 14, fontWeight: '900' },
    pairAction: { flex: 1, minHeight: 44, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: palette.pairActionBorder, borderRadius: 12, borderCurve: 'continuous' },
    ...
    settingsChip: { minHeight: 44, paddingHorizontal: 12, alignItems: 'center', justifyContent: 'center', borderRadius: 10, borderCurve: 'continuous', borderWidth: 1, borderColor: palette.pairCardBorder },
...
export function createPairStyles(palette: Palette) {
  return StyleSheet.create({
    content: { flexGrow: 1, gap: 18, paddingHorizontal: 22, paddingTop: 28, paddingBottom: 42, backgroundColor: palette.pairScreenBg },
    pageIntro: { gap: 10, paddingBottom: 5 },
    eyebrow: { color: palette.pairCount, fontSize: 12, fontWeight: '900', letterSpacing: 1.1 },
    title: { color: palette.pairTitle, fontSize: 34, fontWeight: '800', letterSpacing: -0.8 },
    ...
    card: { gap: 14, padding: 20, borderRadius: 16, borderCurve: 'continuous', borderWidth: 1, borderColor: palette.pairCardBorder, backgroundColor: palette.pairCardBg },
    ...
    remove: { minHeight: 44, paddingHorizontal: 12, alignItems: 'center', justifyContent: 'center', borderRadius: 10, backgroundColor: palette.pairRemoveBg },
    ...
    settingsCard: { gap: 16, padding: 20, borderWidth: 1, borderColor: palette.pairCardBorder, borderRadius: 16, borderCurve: 'continuous', backgroundColor: palette.pairCardBg },
    settingsSection: { gap: 10 },
    settingsLabel: { color: palette.pairLabel, fontSize: 13, fontWeight: '800' },
    settingsRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
    settingsChip: { minHeight: 44, paddingHorizontal: 12, alignItems: 'center', justifyContent: 'center', borderRadius: 10, borderCurve: 'continuous', borderWidth: 1, borderColor: palette.pairCardBorder },
